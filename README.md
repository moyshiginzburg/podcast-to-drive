...
- **Automatic Background Downloads:** The system automatically checks for new episodes every 6 hours and manages a download queue asynchronously for continuous and stable operation.
...
- **Simple UI:** Manage subscriptions (via Apple Podcasts or Podcast Index search, RSS, or OPML) through a clean, Hebrew-localized Sidebar inside Google Sheets, with automatic OPML backups and custom sorting preferences.
...
| Drive **OPML Backup** | An OPML backup of your subscriptions |
...
המערכת **Podcast to Drive** (הסכת לדרייב) היא מנהל הסכתים חכם, פרטי ונקי מפרסומות, הבנויה כולה על גבי סביבת Google Apps Script. היא מאפשרת לכם להירשם להסכתים האהובים עליכם ומורידה אוטומטית פרקים חדשים ישירות ל-Google Drive האישי שלכם, כך שתוכלו להאזין להם מכל מקום בלי להיות תלויים באפליקציות צד-שלישי.
...
- **הורדה אוטומטית ברקע:** המערכת בודקת באופן אוטומטי אם יש פרקים חדשים כל 6 שעות ומנהלת תור הורדות ברקע באופן רציף ויציב.
...
- **ממשק משתמש פשוט:** ניהול מנויים (דרך חיפוש באפל פודקאסט או פודקאסט אינדקס, הזנת כתובת RSS, או ייבוא OPML) דרך חלונית נקייה וידידותית בעברית מתוך Google Sheets, הכוללת גיבוי OPML אוטומטי ואפשרויות מיון.
...
2. לחצו על הכפתור **"צרו עותק של הגיליון"** כדי לשכפל את הגיליון לחשבון שלכם.
3. פתחו את הגיליון שנוצר, היכנסו ללשונית **"התחלה"**, ולחצו על הכפתור הירוק כדי לאשר למערכת את הרשאות הגישה בפעם הראשונה.
4. לאחר אישור ההרשאות, יופיע בתפריט העליון של הגיליון כפתור חדש בשם **`🎙 הסכתים`**. לחצו עליו, בחרו ב"פתח מנהל הסכתים", ותתחילו לארגן את ההסכתים שלכם!
...
| כונן Drive **גיבוי OPML** | עותק גיבוי של המנויים שלכם |
